...
{
    [TestClass]
    public class TValuationSources_Create : Test
    {
        ...
        public void ValuationSource_CreateValuationSources()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToValuationSourcesPopUp();
