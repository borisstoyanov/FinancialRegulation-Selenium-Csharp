...
{
    [TestClass]
    public class TETDIndicators_Create : Test
    {
        ...
        public void ETDIndicator_CreateETDIndicators()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToETDIndicatorsPopUp();
