...
{
    [TestClass]
    public class TFrequencys_Search : Test
    {
        string searchTerm;
        ...
        public void Frequency_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void Frequency_SearchingStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void Frequency_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void Frequency_SearchingFullName()
        {
            storeResults = true;
