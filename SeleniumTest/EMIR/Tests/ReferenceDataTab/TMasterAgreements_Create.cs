...
{
    [TestClass]
    public class TMasterAgreements_Create : Test
    {
        ...
        public void MasterAgreementType_CreateMasterAgreements()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToMasterAgreementsPopUp();
