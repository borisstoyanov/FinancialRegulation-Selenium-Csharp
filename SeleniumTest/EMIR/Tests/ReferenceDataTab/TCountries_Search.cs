...
{
    [TestClass]
    public class TCountries_Search : Test
    {
        string searchTerm;
        ...
        public void SetUp()
        {
            ...
            PO_ReferenceDatasPopUp referenceDatas = PO_Dashboard.GoToCountriesPopUp();
        ...
        public void Country_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void Country_SearchingStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void Country_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void Country_SearchingFullName()
        {
            storeResults = true;
