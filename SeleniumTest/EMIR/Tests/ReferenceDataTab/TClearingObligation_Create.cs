...
{
    [TestClass]
    public class TClearingObligation_Create : Test
    {
        ...
        public void ClearingObligation_CreateClearingObligation()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToClearingObligationsPopUp();
