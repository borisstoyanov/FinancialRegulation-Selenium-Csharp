...
{
    [TestClass]
    public class TProductTaxonomy_Create : Test
    {
        ...
        public void ProductTaxonomy_CreateProductTaxonomy()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToProductTaxonomysPopUp();
