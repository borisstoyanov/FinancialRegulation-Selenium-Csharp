...
{
    public class PO_ReferenceDatasPopUp
    {
        public PO_ReferenceDatasPopUp()
        {
            try
            {
        ...
        public PO_ReferenceDatas_CreateReferenceDataPopUp CreateNewReferenceData()
        {
            ClickCreate();
            return new PO_ReferenceDatas_CreateReferenceDataPopUp();
        }
