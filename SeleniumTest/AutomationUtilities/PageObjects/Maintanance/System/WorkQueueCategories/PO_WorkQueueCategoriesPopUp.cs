...
{
    public class PO_WorkQueueCategoriesPopUp
    {
        public PO_WorkQueueCategoriesPopUp()
        {
            try
            {
        ...
        public PO_WorkQueueCategories_CreateWorkQueueCategoriesPopUp CreateNewWorkQueueCategories()
        {
            ClickCreate();
            return new PO_WorkQueueCategories_CreateWorkQueueCategoriesPopUp();
        }
        ...
        public void VerifyWorkQueueCategoriesCreated()
        {
            Thread.Sleep(2000);
            Util.CheckIfOneOfTextsPresented("has been created", "has been requested");
        }

        public PO_WorkQueueCategories_Edit EditWorkQueueCategories()
        {
            SearchWorkQueueCategories(Test.extRef);
            ClickEdit();
            return new PO_WorkQueueCategories_Edit();
        }

        public void Verify_WorkQueueCategoriesEdited()
        {
            Thread.Sleep(2000);
        ...
        public void SearchWorkQueueCategories(string workQueueCategoriesName)
        {
            Thread.Sleep(2000);
            Browser.Browser.Instance.FindElement(By.Id("Search_NameSearch")).SendKeys(workQueueCategoriesName);
            Browser.Browser.ClickByID("Search");
            Thread.Sleep(2000);
        }

        public PO_WorkQueueCategories_Detail ViewWorkQueueCategoriesDetails()
        {
            SearchWorkQueueCategories(Test.extRef);
            ClickDetails();
            return new PO_WorkQueueCategories_Detail(Test.extRef);
        }
