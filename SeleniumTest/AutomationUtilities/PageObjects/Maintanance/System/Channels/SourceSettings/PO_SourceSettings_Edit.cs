...
{
    public class PO_SourceSettings_Edit
    {
        public PO_SourceSettings_Edit()
        {
            try
            {
        ...
        public PO_SourceSettings_Edit SetSourceSettingsField(String field, String value)
        {
            Browser.Browser.Instance.FindElement(By.Id(field)).SendKeys(value);
            return this;
        }

        public PO_SourceSettings_Edit SetActive(String value)
        {
