...
{
    public class PO_TransactionTypes_Edit
    {
        public PO_TransactionTypes_Edit()
        {
            try
            {
        ...
        public PO_TransactionTypes_Edit SetTransactionTypesField(String field, String value)
        {
            Browser.Browser.Instance.FindElement(By.Id(field)).SendKeys(value);
            return this;
        }

        public PO_TransactionTypes_Edit SetName(String value)
        {
