...
{
    [TestClass]
    public class TValuationTypes_Search : Test
    {
        string searchTerm;
        ...
        public void SetUp()
        {
            ...
            PO_ReferenceDatasPopUp referenceDatas = PO_Dashboard.GoToValuationTypesPopUp();
        ...
        public void ValuationType_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void ValuationType_SearchingStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void ValuationType_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void ValuationType_SearchingFullName()
        {
            storeResults = true;
