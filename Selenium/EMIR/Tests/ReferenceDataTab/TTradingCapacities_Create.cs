...
{
    [TestClass]
    public class TTradingCapacities_Create : Test
    {
        ...
        public void TradingCapacity_CreateTradingCapacities()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToTradingCapacitiesPopUp();
