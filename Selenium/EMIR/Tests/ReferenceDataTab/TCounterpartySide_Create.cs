...
{
    [TestClass]
    public class TCounterpartySide_Create : Test
    {
        ...
        public void CounterpartySide_CreateCounterpartySide()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToCounterpartySidesPopUp();
