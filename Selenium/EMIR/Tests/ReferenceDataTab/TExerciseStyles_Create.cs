...
{
    [TestClass]
    public class TExerciseStyles_Create : Test
    {
        ...
        public void ExerciseStyle_CreateExerciseStyles()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToExerciseStylesPopUp();
