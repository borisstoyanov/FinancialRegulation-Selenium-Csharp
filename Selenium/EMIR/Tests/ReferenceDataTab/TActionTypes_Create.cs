...
{
    [TestClass]
    public class TActionType_Create : Test
    {
        ...
        public void TC14462_ActionType_CreateActionType()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToActionTypesPopUp();
