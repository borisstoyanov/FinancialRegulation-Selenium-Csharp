...
{
    [TestClass]
    public class TDerivativeClasses_Create : Test
    {
        ...
        public void DerivativeClass_CreateDerivativeClasses()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToDerivativeClassesPopUp();
