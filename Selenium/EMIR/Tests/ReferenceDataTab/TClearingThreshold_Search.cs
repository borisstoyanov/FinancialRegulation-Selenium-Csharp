...
{
    [TestClass]
    public class TClearingThresholds_Search : Test
    {
        string searchTerm;
        ...
        public void SetUp()
        {
            ...
            PO_ReferenceDatasPopUp referenceDatas = PO_Dashboard.GoToClearingThresholdsPopUp();
        ...
        public void AboveClearingThreshold_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void AboveClearingThreshold_SearchingStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void AboveClearingThreshold_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void AboveClearingThreshold_SearchingFullName()
        {
            storeResults = true;
