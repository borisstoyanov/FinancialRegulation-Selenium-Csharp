...
{
    [TestClass]
    public class TNonEEAs_Search : Test
    {
        string searchTerm;
        ...
        public void NonEEA_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void NonEEA_SearchingStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void NonEEA_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void NonEEA_SearchingFullName()
        {
            storeResults = true;
