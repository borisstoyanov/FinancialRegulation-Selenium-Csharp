...
{
    [TestClass]
    public class TRateDayCount_Create : Test
    {
        ...
        public void RateDayCount_CreateRateDayCount()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToRateDayCountsPopUp();
