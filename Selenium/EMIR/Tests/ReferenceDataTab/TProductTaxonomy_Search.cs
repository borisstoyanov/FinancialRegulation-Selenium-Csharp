...
{
    [TestClass]
    public class TProductTaxonomys_Search : Test
    {
        string searchTerm;
        ...
        public void SetUp()
        {
            ...
            PO_ReferenceDatasPopUp referenceDatas = PO_Dashboard.GoToProductTaxonomysPopUp();
        ...
        public void ProductTaxonomy_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void ProductTaxonomy_SearchingStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void ProductTaxonomy_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void ProductTaxonomy_SearchingFullName()
        {
            storeResults = true;
