...
{
    [TestClass]
    public class TCommodityBase_Create : Test
    {
        ...
        public void EMIRCommodityBase_CreateCommodityBase()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToCommodityBasesPopUp();
