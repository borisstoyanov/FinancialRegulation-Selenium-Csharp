...
{
    [TestClass]
    public class TUnderlyingTypes_Search : Test
    {
        string searchTerm;
        ...
        public void SetUp()
        {
            ...
            PO_ReferenceDatasPopUp referenceDatas = PO_Dashboard.GoToUnderlyingTypesPopUp();
        ...
        public void UnderlyingType_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void UnderlyingType_SearchingStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void UnderlyingType_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("ReferenceDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void UnderlyingType_SearchingFullName()
        {
            storeResults = true;
