...
{
    [TestClass]
    public class TUnderlyingType_Create : Test
    {
        ...
        public void UnderlyingType_CreateUnderlyingType()
        {
            storeResults = true;
            PO_ReferenceDatasPopUp referenceData = PO_Dashboard.GoToUnderlyingTypesPopUp();
