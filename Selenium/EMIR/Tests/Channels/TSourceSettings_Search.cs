...
{
    [TestClass]
    public class TSourceSettings_Search : Test
    {
        string searchTerm;
        ...
        public void EMIRSourceSetting_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("System"), TestCategory("Maintenance"), TestCategory("Channels"), TestMethod()]
        public void EMIRSourceSetting_SearchingStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("System"), TestCategory("Maintenance"), TestCategory("Channels"), TestMethod()]
        public void EMIRSourceSetting_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("System"), TestCategory("Maintenance"), TestCategory("Channels"), TestMethod()]
        public void EMIRSourceSetting_SearchingFullName()
        {
            storeResults = true;
