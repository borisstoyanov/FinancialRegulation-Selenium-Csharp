...
{
    public class PO_SourceSystems_Edit
    {
        public PO_SourceSystems_Edit()
        {
            try
            {
        ...
        public PO_SourceSystems_Edit SetSourceSystemField(String field, String value)
        {
            Browser.Browser.Instance.FindElement(By.Id(field)).SendKeys(value);
            return this;
        }

        public PO_SourceSystems_Edit SetActive(String value)
        {
