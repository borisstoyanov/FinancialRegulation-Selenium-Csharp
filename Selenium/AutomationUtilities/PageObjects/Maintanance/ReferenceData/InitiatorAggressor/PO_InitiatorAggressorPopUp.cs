using AutomationUtilities.PageObjects.Maintanance.ReferenceData.InitiatorAggressor;
...
namespace AutomationUtilities.PageObjects.ReferenceData.InitiatorAggressor
{
    public class PO_InitiatorAggressorPopUp
    {
        ...
        public PO_InitiatorAggressor_Edit EditReferenceData()
        {
            SearchReferenceData(Test.extRef);
            ClickEdit();
            return new PO_InitiatorAggressor_Edit();
        }
