...
{
    [TestClass]
    public class TMTCollateralAudit_SearchTests : Test
    {
        PO_AuditCollateralsPopUp operationsPopUp;
        ...
        public void SetUp()
        {
            ...
            operationsPopUp = PO_Dashboard.GoToAuditCollaterals();
        ...
        public void TMTCollateralsAudit_CountResponse()
        {
