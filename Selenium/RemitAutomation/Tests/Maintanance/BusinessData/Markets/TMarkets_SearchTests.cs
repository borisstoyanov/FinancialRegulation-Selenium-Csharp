...
namespace RemitAutomation.Tests.Maintanance.BusinessData.Markets
{
    ...
    public class TMarkets_SearchTests : Test
    {
        ...
        public void REMIT_Market_SearchingEndsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("BusinessDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void REMIT_Market_SearchingStartsWithAsterisk()
        {
            storeResults = true;
            searchTerm = Test.extRef.Remove(Test.extRef.Length - 3) + "*";
            markets = new PO_MarketsPopUp();
        ...
        [TestCategory("BusinessDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void REMIT_Market_SearchingEndsAndStartsWithAsterisk()
        {
            storeResults = true;
        ...
        [TestCategory("BusinessDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void REMIT_Market_SearchingFullName()
        {
            storeResults = true;
        ...
        [TestCategory("BusinessDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void REMIT_Market_SearchingEndsWithAsteriskByMIC()
        {
            storeResults = true;
        ...
        [TestCategory("BusinessDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void REMIT_Market_SearchingStartsWithAsteriskByMIC()
        {
            storeResults = true;
            mic = Test.extRef.Remove(Test.extRef.Length - 3);
        ...
        [TestCategory("BusinessDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void REMIT_Market_SearchingEndsAndStartsWithAsteriskByMIC()
        {
            storeResults = true;
            mic = Test.extRef.Remove(Test.extRef.Length - 3);
        ...
        [TestCategory("BusinessDataTab"), TestCategory("Maintenance"), TestCategory("RegressionTesting"), TestMethod()]
        public void REMIT_Market_SearchingFullNameByMIC()
        {
            storeResults = true;
            mic = Test.extRef.Remove(Test.extRef.Length - 3);
            searchTerm = mic;
